...
namespace JunctionController
{
    ...
    /// </summary>
    public class DBConnect : IDataConnect
    {
        ...
        public DBConnect()
        {
            ...
            {
                throw new Exception("Error initiliasing DataConnect", e);
            }
        }
        ...
        private void ReadDBConnData()
        {
            try
            {
                _sqlConnectString = ConfigReader.GetConnectionString("VehicleData");
            }
            catch (Exception e)
            {
                throw new Exception("Error occured reading database details", e);
            }
        }
        ...
        public List<Dictionary<string, object>> SendDataRequest(string spName, Dictionary<string, object> parameters)
        {
            ...
            {
                throw new Exception("Error retrieving record set, using " + spName, e);
            }
        }
        ...
        private List<Dictionary<string, object>> GetRecordSet(string spName, SqlConnection sqlCon, Dictionary<string, object> parameters)
        {
            ...
            {
                throw new Exception("Error Getting Record Set", e);
            }
        }
        ...
        private SqlCommand BuildSqlCommand(string spName, SqlConnection sqlCon, Dictionary<string, object> parameters)
        {
            ...
            {
                throw new Exception("Error building sql command", e);
            }
        }
        ...
        private SqlCommand AddAllParameters(SqlCommand sqlCmd, Dictionary<string, object> parameters)
        {
            ...
            {
                throw new Exception("Error Adding stored procedure parameters", e);
            }
        ...
        private SqlCommand AddParameter(SqlCommand sqlCmd, string parameterKey, object parameterValue)
        {
            ...
            {
                throw new Exception("Error Adding stored procedure parameter", e);
            }
        }
        ...
        private List<Dictionary<string, object>> SqlReader(SqlCommand sqlCmd)
        {
            ...
            {
                throw new Exception("Error reading record set", e);
            }
        }
